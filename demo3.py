...
class Ui_MainWindow(object):
    ...
    def classifyFunction(self):
        ...
        path2=self.file
        print(path2)
        test_image = image.load_img(path2, color_mode='rgb', target_size = (128, 128))        
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory('D:/AI/p9/Dataset/train',
                                                         target_size = (128, 128),
                                                         batch_size = 8,
                                                         color_mode = 'rgb',
        ...
        test_set = test_datagen.flow_from_directory('D:/AI/p9/Dataset/test',
                                                    target_size = (128, 128),
                                                    batch_size = 8,
                                                    color_mode = 'rgb',
                                                    class_mode = 'categorical')
